...
export const MUIButton: React.FC<MUIButtonProps> = ({ children, variant = "contained", className = "", onClick, fullWidth }) => {
...
export const MUICard: React.FC<MUICardProps> = ({ children, className = "" }) => (
