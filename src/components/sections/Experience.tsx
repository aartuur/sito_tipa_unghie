      ...
      <div className="max-w-7xl mx-auto px-6 grid md:grid-cols-2 gap-16 items-center">
        <div className="relative order-2 md:order-1">
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <img
              ...
              alt="Tools"
              className="rounded-2xl shadow-xl w-full h-48 sm:h-64 object-cover mt-12"
            />
            <img
        ...
        <div className="order-1 md:order-2 space-y-6">
          ...
          <p className="text-gray-400 text-lg leading-relaxed">
            In Lumina, non scendiamo a compromessi. Ogni strumento metallico viene
            sottoposto a un ciclo di{" "}
            <strong>sterilizzazione in autoclave di grado medico</strong>. Usiamo
            lime monouso per ogni cliente e prodotti certificati privi di acidi
            aggressivi.
          </p>
