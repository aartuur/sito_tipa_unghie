...
const ArtistBio = () => {
  return (
    <section id="chi-siamo" className="py-24 bg-black relative overflow-hidden">
      ...
      <AnimationWrapper>
        {" "}
        {/* Wrap main content with AnimationWrapper */}
        <div className="max-w-7xl mx-auto px-6 grid lg:grid-cols-2 gap-16 items-center relative z-10">
          ...
          <div className="relative group">
            ...
            <div className="relative rounded-[2rem] overflow-hidden border border-white/10 shadow-2xl">
              <img
                ...
                className="w-full h-[400px] sm:h-[500px] lg:h-[600px] object-cover grayscale hover:grayscale-0 transition-all duration-700"
              />
              ...
              <div className="absolute bottom-0 left-0 w-full bg-gradient-to-t from-black via-black/80 to-transparent p-8 pt-24">
                ...
                <p className="text-rose-400 text-sm tracking-widest uppercase mt-1">
          ...
          <div className="space-y-8">
            ...
            <p className="text-gray-400 text-lg leading-relaxed border-l-2 border-purple-500/30 pl-6">
              Con oltre 10 anni di esperienza internazionale tra Milano e Tokyo,
              ho sviluppato un metodo proprietario che fonde la precisione della
              manicure russa con l'estro artistico italiano. Il mio obiettivo
              non è coprire, ma rivelare l'eleganza naturale delle tue mani.
            </p>
