      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        ...
        <div className="flex flex-col md:flex-row justify-between items-center md:items-end mb-10 md:mb-16 gap-6">
          ...
          <div className="text-center md:text-left w-full md:w-auto">
            ...
            <h2 className="text-4xl md:text-6xl font-serif text-white mt-4 leading-tight">
              Capolavori <br/>
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-white to-gray-400">in Miniatura</span>
            </h2>
          </div>
          
          {/* BOTTONE INSTAGRAM: Larghezza piena su mobile per centrare flex */}
          <a href="#" className="group flex items-center gap-3 text-white border border-white/20 px-8 py-4 rounded-full hover:bg-white hover:text-black transition-all duration-300 w-full md:w-auto justify-center md:justify-start">
            <Instagram className="w-5 h-5 group-hover:scale-110 transition-transform" />
            <span className="text-sm font-medium tracking-wide">@lumina.nails.milano</span>
          </a>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {images.map((img, idx) => (
            <div key={idx} className="group relative overflow-hidden rounded-2xl aspect-[3/4] cursor-pointer border border-white/5">
              <img 
                src={img.src} 
                alt={img.title}
                onError={(e) => {
        ...
        <div className="text-center mt-12">
            <p className="text-gray-500 text-sm tracking-wide">
                Guarda altri <span className="text-white font-bold">120+ lavori</span> sul nostro profilo social
            </p>
        </div>
