...
const MarketingStrip = () => (
  ...
  <div className="bg-gradient-to-r from-rose-900 to-purple-900 py-12 relative overflow-hidden">
    ...
    <div className="max-w-7xl mx-auto px-6 flex flex-col md:flex-row items-center justify-between gap-8 relative z-10 text-center md:text-left animate-fade-in-up">
